module.exports = class setslogan {
    ...
    async run(client, message, args) {
        message.delete();
        if (!args[1]) return;
        let slogan = message.content.slice(args[0].length + 1);
